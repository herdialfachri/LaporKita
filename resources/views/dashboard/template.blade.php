...
<head>
    ...
    <link rel="stylesheet" href="assets/admin_panel/css/main.css?v=1772427751095">
...
<body>
    ...
    <div id="app">
        ...
        <nav id="navbar-main" class="navbar is-fixed-top">
            ...
            <div class="navbar-menu" id="navbar-menu">
                <div class="navbar-end">
                    ...
                    <a title="Keluar" class="navbar-item desktop-icon-only">
        ...
        <aside class="aside is-placed-left is-expanded">
            ...
            <div class="menu is-menu-main">
                ...
                <ul class="menu-list">
                    ...
                    <li>
                        <a href="https://themewagon.com/themes/free-tailwind-css-html5-admin-dashboard-template-admin-one/" target="_blank" class="has-icon">
        ...
        <section class="is-title-bar">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
                ...
                <a href="#!" class="hidden" class="button blue">
                    <span class="icon"><i class="mdi mdi-credit-card-outline"></i></span>
        ...
        <section class="section main-section">
            <div class="grid gap-6 grid-cols-1 md:grid-cols-5 mb-6">
                <div class="card">
        ...
        <footer class="footer">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
                <div class="flex items-center justify-start space-x-3">
                    ...
                    <a href="https://github.com/themewagon/admin-one" style="height: 20px">
                        <img src="https://img.shields.io/github/v/release/themewagon/admin-one?color=%23999">
                    </a>
                </div>
                <a href="#!">
    ...
    <script type="text/javascript" src="assets/admin_panel/js/main.min.js?v=1772427751095"></script>

    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js"></script>
    <script type="text/javascript" src="assets/admin_panel/js/chart.sample.min.js"></script>
