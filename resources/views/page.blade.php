            ...
            <div class="flex flex-row flex-wrap -mx-3">
              <div class="max-w-full w-full px-4">
                ...
                <div class="leading-relaxed pb-4">
                  ...
                  <h2 class="w-full float-left text-xl leading-normal mb-2 font-semibold text-gray-800">Start your Morning with Smiles</h2>
                  ...
                  <h2 class="w-full float-left text-xl leading-normal mb-2 font-semibold text-gray-800">Live as if you were to die tomorrow.</h2>
