                ...
                <div class="p-4 border border-gray-100 bg-white mb-4">
                  <div class="flex flex-row items-center">
                    ...
                    <div class="ml-8">
                      ...
                      <!-- website -->
                      <p><a class="hover:text-blue-500" rel="noopener" href="#!">https://aribudin.com</a></p>
                      <!--description-->
                      ...
                      <div class="mt-2">
                        <ul class="space-x-3">
                          ...
                          <li class="inline-block">
                            <a class="hover:text-gray-900" rel="noopener noreferrer" href="#!" title="Facebook">
                          ...
                          <!--twitter-->
                          <li class="inline-block">
                            <a class="hover:text-gray-900" rel="noopener noreferrer" href="#!" title="Twitter">
                          ...
                          <!--instagram-->
                          <li class="inline-block">
                            <a class="hover:text-gray-900" rel="noopener noreferrer" href="#!" title="Instagram">
